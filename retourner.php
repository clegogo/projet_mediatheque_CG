...
<body>
  <div class="container">
    ...
    <h1>Retourner un ouvrage emprunté</h1>
    <div class="row">
        ...
        <section class="col-sm-10">
          <div class="card col-sm-10 offset-1">
            ...
            <div class="card-body">
              <form id="emprunt"  method="get" action="script/retour.php">
                <div class="form-group" style ="display:none;">
                    <label>Test utilisateur until login setup</label>
                ...
                if (isset($_GET["rep"])) {
                  ...
                  switch ($code) {
                    case 1:
                      ...
                      break;
                    case 2:
                      $message = "Vous devez entrer un identifiant pour l'ouvrage";
                      break;
                    case 3:
                      $message = "Cet ouvrage n'existe pas dans votre liste d'emprunts en cours";
                      break;
                    case 4:
                      $message = "Retour de l'ouvrage enregistré";
                      break;
                  }
